...
class BrushButton(GameObject):
    def __init__(self):
        ...
        self.image = pygame.transform.scale(pygame.image.load('./assets/brush.png'), (50, 50))
...
class EraserButton(GameObject):
    ...
    def __init__(self):
        ...
        self.image = pygame.transform.scale(pygame.image.load('./assets/eraser.png'), (self.width, self.width))
        self.rect = self.image.get_rect()
...
class Pen(GameObject):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.image = pygame.transform.scale(pygame.image.load('./assets/brush.png'), (40, 40))
...
class Rectangle(GameObject):
    ...
    def draw(self, surf, *args, **kwargs):
        ...
        self.rect = pygame.draw.rect(surf, self.color, (
        start_point_x, start_point_y, end_point_x - start_point_x, end_point_y - start_point_y), width=5)
...
class Eraser(GameObject):
    def __init__(self, *args, **kwargs):
        self.pos = pygame.mouse.get_pos()
        self.image = pygame.transform.scale(pygame.image.load('./assets/eraser.png'), (20, 20))
        self.rect = self.image.get_rect()
        self.rect.bottomleft = self.pos

...
y = 0
points = []
colors = {"blue": (0, 0, 255), "red": (255, 0, 0), "green": (0, 255, 0), "yellow": (255, 255, 0), "black": (0, 0, 0),
    ...
    for event in pygame.event.get():
        ...
        if mode == 2:
            ...
            if mouse_down and prevX != -1 and prevY != -1 and currentX != -1 and currentY != -1:
                screen.blit(screen2, (0, 0))
                pygame.draw.circle(screen, color, (prevX, prevY), max(abs(prevX - currentX), abs(prevY - currentY)),
                                   radius)
        ...
        if mode == 3:
            ...
            if mouse_down and prevX != -1 and prevY != -1 and currentX != -1 and currentY != -1:
                ...
                pygame.draw.rect(screen, color,
                                 pygame.Rect(min(prevX, currentX), min(prevY, currentY), abs(prevX - currentX),
                                             abs(prevY - currentY)), radius)
